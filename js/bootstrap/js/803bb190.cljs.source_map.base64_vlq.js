...
var digit_22078 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22079__$1 = (vlq >>> (5));
while(true){
if((vlq_22079__$1 > (0))){
var digit_22080__$1 = (digit_22078 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22080__$1));

var G__22081 = (vlq_22079__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22082 = (vlq_22079__$1 >>> (5));
digit_22078 = G__22081;
vlq_22079__$1 = G__22082;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22078));
}
break;
}
...
var G__22086 = i__$1;
var G__22087 = result__$1;
var G__22088 = shift__$1;
i = G__22086;
result = G__22087;
shift = G__22088;
continue;
