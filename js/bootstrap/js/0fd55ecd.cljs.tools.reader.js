...
var G__21874 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__21874;
continue;
}
break;
...
var G__21751 = (function (){var G__21755 = rdr;
G__21755.cljs$tools$reader$reader_types$IPushbackReader$unread$arity$2(null,ch);

return G__21755;
})();
var G__21752 = ch;
var G__21753 = opts;
var G__21754 = pending_forms;
return (cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4(G__21751,G__21752,G__21753,G__21754) : cljs.tools.reader.read_tagged.call(null,G__21751,G__21752,G__21753,G__21754));
}
} else {
...
if(("\\" === ch__$1)){
var ch_21875__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_21875__$2 == null)){
...
var vec__21758 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21758,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21758,(1),null);
...
var G__21882 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__21882;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__21761 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__21762 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__21762);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__21761);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__21763 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21763,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21763,(1),null);
var the_list = cljs.tools.reader.read_delimited(new cljs.core.Keyword(null,"list","list",765357683),")",rdr,opts,pending_forms);
var vec__21766 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21766,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21766,(1),null);
...
var sb = (function (){var G__21781 = (new goog.string.StringBuffer());
G__21781.append(initch);
...
var G__21883 = (function (){var G__21782 = sb;
G__21782.append(ch);
...
switch (G__21784) {
case "\\":
var G__21887 = (function (){var G__21785 = sb;
G__21785.append(cljs.tools.reader.escape_char(sb,reader));

return G__21785;
})();
var G__21888 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__21887;
ch = G__21888;
continue;
...
break;
default:
var G__21889 = (function (){var G__21786 = sb;
G__21786.append(ch);

return G__21786;
})();
var G__21890 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__21889;
ch = G__21890;
continue;
...
var vec__21790 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21790,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21790,(1),null);
...
var vec__21794 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21794,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21794,(1),null);
...
var vec__21799 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21799,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21799,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta((cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms)));
if(cljs.core.map_QMARK_(m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata(rdr,m);
...
var G__21810 = rdr;
(cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__21810,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,G__21810,true,null,opts,pending_forms));
...
var G__21811 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__21811)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__21811)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__21811)){
...
var _STAR_suppress_read_STAR__orig_val__21812 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__21813 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__21813);

try{var form = (function (){var G__21814 = rdr;
var G__21815 = false;
var G__21816 = cljs.tools.reader.READ_EOF;
var G__21817 = ")";
var G__21818 = opts;
var G__21819 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__21814,G__21815,G__21816,G__21817,G__21818,G__21819) : cljs.tools.reader.read_STAR_.call(null,G__21814,G__21815,G__21816,G__21817,G__21818,G__21819));
})();
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__21812);
}});
...
var feature = (function (){var G__21820 = rdr;
var G__21821 = false;
...
var G__21826 = (function (){var G__21827 = rdr;
var G__21828 = false;
var G__21829 = cljs.tools.reader.READ_EOF;
var G__21830 = ")";
var G__21831 = opts;
var G__21832 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__21827,G__21828,G__21829,G__21830,G__21831,G__21832) : cljs.tools.reader.read_STAR_.call(null,G__21827,G__21828,G__21829,G__21830,G__21831,G__21832));
})();
cljs.tools.reader.check_eof_error(G__21826,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond(G__21826,rdr,first_line);
...
var G__21894 = matched;
var G__21895 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__21894;
finished = G__21895;
continue;
} else {
...
if(cljs.core.truth_(and__4115__auto__)){
var G__21835 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__21834 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
return (fexpr__21834.cljs$core$IFn$_invoke$arity$1 ? fexpr__21834.cljs$core$IFn$_invoke$arity$1(G__21835) : fexpr__21834.call(null,G__21835));
} else {
return and__4115__auto__;
}
})())){
...
var _STAR_suppress_read_STAR__orig_val__21836 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__21837 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__21837);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__21836);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__21838 = cljs.tools.reader.arg_env;
var arg_env_temp_val__21839 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__21839);

try{var form = (function (){var G__21840 = (function (){var G__21845 = rdr;
cljs.tools.reader.reader_types.unread(G__21845,"(");
...
var G__21842 = null;
var G__21843 = opts;
var G__21844 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__21840,G__21841,G__21842,G__21843,G__21844) : cljs.tools.reader.read_STAR_.call(null,G__21840,G__21841,G__21842,G__21843,G__21844));
})();
...
var G__21896 = (i + (1));
var G__21897 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__4126__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__21838);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__21846 = rdr;
G__21846.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__21898 = cljs.core.next(s__$1);
var G__21899 = ret;
s__$1 = G__21898;
r = G__21899;
continue;
...
var G__21900 = cljs.core.next(s);
var G__21901 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__21900;
key_vals = G__21901;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__21850 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__21850) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__21850));
...
var gensym_env_orig_val__21852 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__21853 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__21853);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__21852);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__21854 = token;
var G__21854__$1 = (((G__21854 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__21854,(1)));
var G__21854__$2 = (((G__21854__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__21854__$1));
var G__21854__$3 = (((G__21854__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__21854__$2));
var G__21854__$4 = (((G__21854__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__21854__$3));
if((G__21854__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__21854__$4);
}
})():(function (){var G__21855 = token;
var G__21855__$1 = (((G__21855 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__21855));
if((G__21855__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__21855__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__21858 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
...
var G__21859 = tag;
var G__21860 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__21859,G__21860) : f.call(null,G__21859,G__21860));
} else {
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__21866,reader){
...
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21867__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
