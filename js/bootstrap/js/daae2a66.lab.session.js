...
if(cljs.core.truth_((function (){var fexpr__26101 = cljs.core.set(lab.session.session_names);
return (fexpr__26101.cljs$core$IFn$_invoke$arity$1 ? fexpr__26101.cljs$core$IFn$_invoke$arity$1(name) : fexpr__26101.call(null,name));
})())){
...
var G__26102 = (function (){var or__4126__auto__ = window.localStorage.getItem(["session-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join(''));
...
var G__26102__$1 = (((G__26102 == null))?null:JSON.parse(G__26102));
if((G__26102__$1 == null)){
return null;
} else {
return [lab.session.help_text,cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26102__$1)].join('');
}
}
});
lab.session.session_load_display = (function lab$session$session_load_display(){
return ["<div","",">","<h2>Select a session to load</h2>",(function (){var attrs26128 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function lab$session$session_load_display_$_iter__26153(s__26154){
