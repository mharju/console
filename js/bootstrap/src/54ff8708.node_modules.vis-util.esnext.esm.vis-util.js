...
exports.toArray = exports.option = exports.extend = exports.easingFunctions = exports.DELETE = void 0;
...
function deepObjectAssignNonentry() {
  ...
  try {
    for (var _iterator = Reflect.ownKeys(b)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var prop = _step.value;
      if (!Object.prototype.propertyIsEnumerable.call(b, prop)) ;else if (b[prop] === DELETE) {
        delete a[prop];
      } else if (a[prop] !== null && b[prop] !== null && _typeof(a[prop]) === "object" && _typeof(b[prop]) === "object" && !Array.isArray(a[prop]) && !Array.isArray(b[prop])) {
